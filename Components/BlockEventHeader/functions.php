...
namespace Flynt\Components\BlockEventHeader;

use Flynt\Utils\Options;

add_filter('Flynt/addComponentData?name=BlockEventHeader', function ($data) {
...
Options::addTranslatable('BlockEventHeader', [
    [
