...
{
    $labels = [
        'name'                  => _x('Veranstaltungen', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Veranstaltung', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Veranstaltungen', 'flynt'),
        'name_admin_bar'        => __('Veranstaltungen', 'flynt'),
    ...
    $args = [
        ...
        'description'           => __('Veranstaltung Description', 'flynt'),
        'labels'                => $labels,
        'supports'              => ['title', 'thumbnail'],
        'taxonomies'            => ['format', 'modus'],
        'hierarchical'          => false,
        'public'                => true,
        'show_ui'               => true,
        'show_in_menu'          => true,
