...
function registerLernenPostType()
{
    $labels = [
        'name'                  => _x('Lernen', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Lernen', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Lernen', 'flynt'),
        'name_admin_bar'        => __('Lernen', 'flynt'),
    ...
    $args = [
        'label'                 => __('Lernen', 'flynt'),
        'description'           => __('Lernen Description', 'flynt'),
        'labels'                => $labels,
        'supports'              => ['title', 'thumbnail'],
        'taxonomies'            => ['lernformat', 'veranstaltungsmonat'],
        'hierarchical'          => false,
        'public'                => true,
        'show_ui'               => true,
        'show_in_menu'          => true,
    ...
    register_post_type('lernen', $args);
}

add_action('init', '\\Flynt\\CustomPostTypes\\registerLernenPostType');
