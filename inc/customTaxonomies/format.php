...
function registerFormatTaxonomy()
{
    $labels = [
        'name'                       => _x('Formats', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Format', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Format', 'flynt'),
    ...
    register_taxonomy('format', ['event'], $args);
}

add_action('init', 'Flynt\\CustomTaxonomies\\registerFormatTaxonomy');
