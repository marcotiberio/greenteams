...
function registerLernformatTaxonomy()
{
    $labels = [
        'name'                       => _x('Lernformate', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Lernformat', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Lernformat', 'flynt'),
    ...
    register_taxonomy('lernformat', ['lernen'], $args);
}

add_action('init', 'Flynt\\CustomTaxonomies\\registerLernformatTaxonomy');
