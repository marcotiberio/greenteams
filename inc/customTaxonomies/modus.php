...
function registerModusTaxonomy()
{
    $labels = [
        'name'                       => _x('Ort / Modus', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Ort / Modus', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Ort / Modus', 'flynt'),
    ...
    register_taxonomy('modus', ['event'], $args);
}

add_action('init', 'Flynt\\CustomTaxonomies\\registerModusTaxonomy');
