...
function registerThemaTaxonomy()
{
    $labels = [
        'name'                       => _x('Themen', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Thema', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Thema', 'flynt'),
    ...
    register_taxonomy('thema', ['post'], $args);
}

add_action('init', 'Flynt\\CustomTaxonomies\\registerThemaTaxonomy');
