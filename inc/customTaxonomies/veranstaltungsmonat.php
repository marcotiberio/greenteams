...
function registerVeranstaltungsmonatTaxonomy()
{
    $labels = [
        'name'                       => _x('Veranstaltungsmonate', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Veranstaltungsmonat', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Veranstaltungsmonate', 'flynt'),
    ...
    register_taxonomy('veranstaltungsmonat', ['lernen'], $args);
}

add_action('init', 'Flynt\\CustomTaxonomies\\registerVeranstaltungsmonatTaxonomy');
